...
Scheme
{
	...
	Colors
	{
		...
		// background colors
		"ControlBG"			"110 110 110 255"		// background color of controls
		"ControlDarkBG"		"66 66 66 255"		// darker background color; used for background of scrollbars
		"WindowBG"			"99 99 99 255"		// background color of text edit panes (chat, text entries, etc.)
		...
		// slider tick colors
		"SliderTickColor"	"140 140 140 255"
		"SliderTrackColor"	"31 31 31 255"

		// border colors
		"BorderBright"		"146 145 148 255"	// the lit side of a control
		"BorderDark"		"40 40 34 255"		// the dark/unlit side of a control
